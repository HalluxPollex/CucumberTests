Feature: Manage Addresses
  ...
  Background:
    ...
    When I log in using my valid email "pan.testerski@test.com" and password "Pa$$word":
  ...
  Scenario Outline: Create and delete an address
    ...
    And I fill in the "<Alias>","<Address>", "<City>", "<PostalCode>", "<Phone>"
    And I click the Save button
    And I can see success alert
    Then I verify provided details : "<Alias>","<Address>", "<City>", "<PostalCode>", "<Phone>" are correct
    ...
    Examples:
      ...
      | Work  | 123 Main Street | Anytown | 12345      | +1-555-5555 |